                    ...
                    <div className="tab-shop">
                        <header className="shop-header">
                            ...
                            <div className="shop-tabs">
                                <button className={shopCategory === 'clicks' ? 'active' : ''} onClick={() => setShopCategory('clicks')}>КЛИК</button>
                                <button className={shopCategory === 'passive' ? 'active' : ''} onClick={() => setShopCategory('passive')}>ДОХОД</button>
                                <button className={shopCategory === 'boxes' ? 'active' : ''} onClick={() => setShopCategory('boxes')}>БОКСЫ</button>
                            </div>
                        </header>
                            ...
                            {shopCategory === 'clicks' && (
                                <div className="upg-list">
                                    <div className="upg-card" onClick={() => buyUpgrade('click')}>
                                        <div className="upg-icon-frame"><div className="icon-bolt"></div></div>
                                        <div className="upg-details">
                                            <h3>Мультитап</h3>
                                            <p>Увеличение силы нажатия</p>
                                            <small>Текущий уровень: {clickPower}</small>
                                        </div>
                                        <div className="upg-buy"><span>{clickPower * 100}</span></div>
                                    </div>
                                </div>
                            )}
                            ...
                            {shopCategory === 'passive' && (
                                <div className="upg-list">
                                    <div className="upg-card" onClick={() => buyUpgrade('passive')}>
                                        <div className="upg-icon-frame"><div className="icon-gear"></div></div>
                                        <div className="upg-details">
                                            <h3>Авто-майнер</h3>
                                            <p>Прибыль в автоматическом режиме</p>
                                            <small>Сейчас: {passiveIncome}/сек</small>
                                        </div>
                                        <div className="upg-buy"><span>{(Math.floor(passiveIncome / 5) + 1) * 150}</span></div>
                                    </div>
                                </div>
                            )}
                            ...
                            {shopCategory === 'boxes' && (
                                <div className="upg-list">
                                    <div className="upg-card locked">
                                        <div className="upg-icon-frame"><div className="icon-box"></div></div>
                                        <div className="upg-details">
                                            <h3>Секретный кейс</h3>
                                            <p>Случайные бонусы и награды</p>
                                        </div>
                                        <div className="upg-buy"><span>BLOCKED</span></div>
                                    </div>
                                </div>
                            )}
                        </div>
                    ...
                    <div className="tab-leaderboard">
                        <header className="leader-header">
                            ...
                            <div className="leader-tabs">
                                <button className={leaderboardCategory === 'all' ? 'active' : ''} onClick={() => setLeaderboardCategory('all')}>ВСЕ ВРЕМЯ</button>
                                <button className={leaderboardCategory === 'month' ? 'active' : ''} onClick={() => setLeaderboardCategory('month')}>ЗА МЕСЯЦ</button>
                            </div>
                        </header>
                                    ...
                                    leaderboard.map((player, index) => (
                                        <div key={index} className={`leader-card ${index === 0 ? 'top-1' : ''}`}>
                                            <div className="player-rank">
                                                {index + 1 <= 3 ? <div className={`rank-badge rank-${index + 1}`}></div> : <span>{index + 1}</span>}
                                            </div>
            ...
            <nav className="navbar-container">
                <div className="navbar">
                    <button className={activeTab === 'home' ? 'active' : ''} onClick={() => handleTabChange('home')}>
                        <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                        <span>Главная</span>
                    </button>
                    <button className={activeTab === 'inventory' ? 'active' : ''} onClick={() => handleTabChange('inventory')}>
                        <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path><rect x="2" y="8" width="20" height="12" rx="2"></rect><line x1="2" y1="14" x2="22" y2="14"></line></svg>
                        <span>Инвентарь</span>
                    </button>
                    <button className={activeTab === 'shop' ? 'active' : ''} onClick={() => handleTabChange('shop')}>
                        <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
                        <span>Магазин</span>
                    </button>
                    <button className={activeTab === 'leaderboard' ? 'active' : ''} onClick={() => handleTabChange('leaderboard')}>
                        <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"></path><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"></path><path d="M4 22h16"></path><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"></path><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"></path><rect x="6" y="4" width="12" height="11" rx="2"></rect></svg>
                        <span>Топы</span>
                    </button>
